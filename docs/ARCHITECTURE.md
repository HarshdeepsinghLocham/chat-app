...
| **Eng rule** | Execution mode is always enforced. False auto-execute under effective `suggest_only` is a **P0** product bug ([ADR-005](./decisions/ADR-005-suggest-first-work-coordination.md) Consequences). |
